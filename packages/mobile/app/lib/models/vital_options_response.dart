class VitalOptionsResponse {
  ...
  VitalOptionsResponse(
      {this.status, this.response, this.data, this.message, this.errMessage});

  VitalOptionsResponse.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class VitalData {
  ...
  VitalData.fromJson(Map<String, dynamic> json) {
