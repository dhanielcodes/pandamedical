  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(elevation: 0, centerTitle: true,
        title: CustomText(text: 'Change Password', color: AppColors.blue, big:true, bold: true),
          ...
          Positioned(
            ...
            Card(margin: EdgeInsets.symmetric(vertical:10, horizontal: 15),
                        ...
                        Card(shadowColor: AppColors.grey1, elevation: 14,
                          ...
                          SizedBox(height:20),
                          CustomText(text: 'New Password*', color: AppColors.blue,  bold: true),
                        SizedBox(height:10),
                        Card(shadowColor: AppColors.grey1, elevation: 14,
                          shape: RoundedRectangleBorder(borderRadius:  BorderRadius.circular(15.0),   ),
                          child: CustomFormField(compulsory: true,
                          ...
                          SizedBox(height:20),
                          CustomText(text: 'Confirm Password*', color: AppColors.blue,  bold: true),
                        SizedBox(height:10),
                        Card(shadowColor: AppColors.grey1, elevation: 14,
                          shape: RoundedRectangleBorder(borderRadius:  BorderRadius.circular(15.0),   ),
                          child: CustomFormField(compulsory: true,
