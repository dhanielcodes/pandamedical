...
class ChangeUnitBloc extends Bloc<ChangeUnitEvent, ChangeUnitState>{
  ...
  @override
 ChangeUnitState get initialState => const ChangeUnitState();

@override
  void onTransition(Transition<ChangeUnitEvent, ChangeUnitState> transition) {
    print(transition);
  ...
  @override
  Stream<ChangeUnitState> mapEventToState(ChangeUnitEvent event) async*{

     if (event is InitChangeUnit) {
