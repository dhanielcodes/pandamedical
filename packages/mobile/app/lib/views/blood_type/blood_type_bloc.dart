...
class BloodTypeBloc extends Bloc<BloodTypeEvent, BloodTypeState>{
  ...
  @override
 BloodTypeState get initialState => const BloodTypeState();

@override
  void onTransition(Transition<BloodTypeEvent, BloodTypeState> transition) {
    print(transition);
  ...
  @override
  Stream<BloodTypeState> mapEventToState(BloodTypeEvent event) async*{

     if (event is InitBloodType) {
