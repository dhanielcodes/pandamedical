...
part 'primary_specialist_event.dart';
part 'primary_specialist_state.dart';


class PrimarySpecialistBloc extends Bloc<PrimarySpecialistEvent, PrimarySpecialistState>{
  //final bloc = this;
  //AuthRepository _repository =  AuthRepository();

  @override
 PrimarySpecialistState get initialState => const PrimarySpecialistState();

@override
  void onTransition(Transition<PrimarySpecialistEvent, PrimarySpecialistState> transition) {
    print(transition);
  ...
  @override
  Stream<PrimarySpecialistState> mapEventToState(PrimarySpecialistEvent event) async*{

     if (event is InitPrimarySpecialist) {
    ...
    }else if(event is PrimarySpecialist){
