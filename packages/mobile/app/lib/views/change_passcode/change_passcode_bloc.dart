...
class ChangePasscodeBloc extends Bloc<ChangePasscodeEvent, ChangePasscodeState>{
  //final bloc = this;
  //AuthRepository _repository =  AuthRepository();

  @override
 ChangePasscodeState get initialState => const ChangePasscodeState();

@override
  void onTransition(Transition<ChangePasscodeEvent, ChangePasscodeState> transition) {
    print(transition);
  ...
  @override
  Stream<ChangePasscodeState> mapEventToState(ChangePasscodeEvent event) async*{
