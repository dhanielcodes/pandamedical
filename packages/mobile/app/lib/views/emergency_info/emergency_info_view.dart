...
final TextEditingController controller = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    var _bloc = BlocProvider.of<EmergencyInfoBloc>(context);
     _bloc.add(InitEmergencyInfo());
    
    final  screenHeight = MediaQuery.of(context).size.height;
    return Scaffold(
      resizeToAvoidBottomInset: true,
      appBar: AppBar(elevation: 0, centerTitle: true,
        title: CustomText(text: 'Emergency Contact', color: AppColors.blue, big:true, bold: true),
          ...
          Positioned(
            ...
            Card(margin: EdgeInsets.symmetric(vertical:10, horizontal: 15),
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                              children: <Widget>[
                            // BlocBuilder<EmergencyInfoBloc, EmergencyInfoState>(
                        ...
                        Card(shadowColor: AppColors.grey1, elevation: 14,
                          ...
                          placeholder: 'Contact Name',
                            ...
                            SizedBox(height:20),
                            CustomText(text: 'Phone Number', color: AppColors.blue,  bold: true),
                            Card(shadowColor: AppColors.grey1, elevation: 14,
                          shape: RoundedRectangleBorder(borderRadius:  BorderRadius.circular(15.0),   ),
                          child: Container(
                      height:84,
                    ...
                    child: BlocBuilder<EmergencyInfoBloc, EmergencyInfoState>(
