  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Padding(padding: EdgeInsets.symmetric(vertical: statusBarHeight, horizontal: 15),
          ...
          children: <Widget>[
            SizedBox(height:20),
            CustomText(text: 'Retype your pin', color: AppColors.blue, bold: true),
            SizedBox(height:50),
            Container(
              height:50,
            ...
            SizedBox(height:60),
            CustomButton(key: Key('resetPinBtn'),
              label:'CONTINUE', onPress:(){
                Navigator.pushNamedAndRemoveUntil(context, DashboardViewRoute, (Route<dynamic> route) => false);
                //pushNamedAndRemoveUntil(DashboardViewRoute, (Route<dynamic> route) => false);
                  }),
