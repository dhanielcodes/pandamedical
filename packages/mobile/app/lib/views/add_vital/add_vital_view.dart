...
class AddVitalView extends StatefulWidget {
  ...
  const AddVitalView(this.vitalOptions);

  @override
  _AddVitalViewState createState() => _AddVitalViewState(vitalOptions);
}
...
class _AddVitalViewState extends State<AddVitalView> {
  ...
  AddVitalBloc _bloc;
  final List<VitalData> vitalOptions;
  String comment, source, generated_by, timestamp, date_entered, user_id;
   _AddVitalViewState(this.vitalOptions);

  @override
  void initState() {
    super.initState();
     _bloc = BlocProvider.of<AddVitalBloc>(context);
     _bloc.add(InitAddVital(vitalOptions));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(elevation: 0, centerTitle: true,
        title: CustomText(text: 'Add Vital(s)', color: AppColors.blue, big:true, bold: true),
          ...
          Positioned(
            ...
            Card(margin: EdgeInsets.symmetric(vertical:10, horizontal: 15),
                            ...
                            Card(shape: RoundedRectangleBorder(borderRadius:  BorderRadius.circular(50.0),
                              ...
                              elevation: 2, child:IconButton(onPressed: (){ _bloc.add(AddVital());}, 
                        ...
                        Form(key: _key,
                          ...
                          onPress:(){
                              ...
                              if( _key.currentState.validate()){ 
                                _bloc.add(Submit(comment, date_entered, timestamp, context));
