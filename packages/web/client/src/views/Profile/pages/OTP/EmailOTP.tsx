...
import EmailImage from '../../../../shared/themes/assets/images/OTPEmail.svg';
import { AuthContext } from '../../../../store/context';
import axiosCustom from '../../../../utilities/axios';

const EmailOTP = ({ history }: RouteComponentProps) => {
  ...
  return (
    <div className="ForgotPassword ProfileOTP OTP">
      ...
      <p className="ProfileOTP-text">
        Verify your Email with <br /> codes sent to you
      </p>

      <img src={EmailImage} alt="phone" className="ForgotPassword-otp-image" />
