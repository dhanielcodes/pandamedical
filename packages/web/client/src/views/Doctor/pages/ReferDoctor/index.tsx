...
const ReferDoctor = ({ history }: RouteComponentProps) => {
    ...
    <div className="BookAppointment SpecialityProfiles">
      <div className="BookAppointment-header">
        <div className="SpecialityProfiles-text-location-container">
          ...
          <p className="SpecialityProfiles-speciality">Ophthalmologist</p>
      ...
      >
        <DoctorFilter closeModal={onCloseFilterModal} />
      </Modal>
    </div>
  );
};

export default withRouter(ReferDoctor);
