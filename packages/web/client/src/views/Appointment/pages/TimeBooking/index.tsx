...
const TimeBooking = ({ history, match }: RouteComponentProps<RouteParams>) => {
    ...
    <div className="TimeBooking">
      ...
      <div className="BookAppointment-header">
        <div className="TimeBooking-back-text">
          ...
          <p className="TimeBooking-header-text">Select a time slot</p>
        </div>
      </div>
            ...
            <div className="TimeBooking-timeslots">
              {timeSlots.length ? (
                <>
                  ...
                  <Link
                    to={`/appointment/confirmation/${doctorId}/${selectedDate}/${selectedTime}`}
                    className="link"
                    onClick={(e) => !selectedTime && e.preventDefault()}
                  >
                    <div className="TimeBooking-book-btn">Book Now</div>
                  </Link>
                </>
              ) : (
      ...
      <Toolbar onButtonClick={onOpenModal} backgroundColor="transparent" />
...
export default withRouter(TimeBooking);
